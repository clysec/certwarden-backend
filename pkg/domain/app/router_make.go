...
func (app *Application) makeRouterAndRoutes() {
	...
	router.handleAPIRouteInsecure(http.MethodPost, apiUrlPath+"/v1/app/auth/oidc", app.auth.StartOidcAuthProcess)
	router.handleAPIRouteInsecure(http.MethodPost, apiUrlPath+"/v1/app/auth/oidclogin", app.auth.LoginUserWithOidc)
